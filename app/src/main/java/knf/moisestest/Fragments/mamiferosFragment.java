...
public class mamiferosFragment extends Fragment {
    public mamiferosFragment() {
    }
    ...
    private void setUpViews(View view) {
        ...
        recyclerView.setAdapter(new AnimalListAdapter(getActivity(), ContentFactory.AnimalType.MAMIFEROS));
    }
}
